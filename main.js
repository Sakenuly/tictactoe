...
// function getText(e) {
// 	if (e.target.classList.contains('tictac__button') && e.target.textContent === '') {
// 		if (count === false) {
...
// 	}
// }
// document.addEventListener("click", getText);


// function checkWinner(el) {
// 	obj.forEach(element => {
// 		if (array[element[1]].textContent === el && array[element[2]].textContent === el && array[element[3]].textContent === el) {
// 			alert(`Победили ${el}`)
// 			count = false
// 			clear()
// 			return
